...
%% Last-Updated: 2020-01-19T09:21:16+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item the full histogram $\yHm\defd(\yHHm_{0},\yHHm_{1}, \yHHm_{2},\dotsc)$
  of the number of projections for that mouse: $\yHHm_{0}$ neurons receive
  no projection, that is, we have $\yNm_{j}=0$ for $\yHHm_{0}$ different
  $j$s; $\yHHm_{1}$ neurons receive only one projection, that is,
  $\yNm_{j}=1$ for $\yHHm_{1}$ different $j$s; $\yHHm_{2}$ receive two
  projections; and so on. From such histogram we can calculate the mean and
  variance above; for example $\yNma = \frac{1}{\yJm}\sum_{n}n\,\yHHm_{n}$.
\end{itemize}
