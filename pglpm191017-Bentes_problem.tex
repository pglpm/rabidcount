...
%% Last-Updated: 2020-01-16T11:52:22+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
and target type $T$, thus obtaining the proportion for each combination.

But the question above is still imprecise. Are we asking it about a
specific mouse? Or are we asking about the average across all mice of a
particular kind or with particular characteristics? The difference is
important for the application of the probability calculus, and the answers
to the two questions can be slightly different.
