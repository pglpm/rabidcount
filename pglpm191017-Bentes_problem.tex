...
%% Last-Updated: 2020-01-16T21:29:01+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
regions project to others. It is impossible, at least at present, to simply
count individual projections. What is done experimentally, with very clever
...
\enquote{typical} brain. We show here how to make this inference using the
probability-calculus, also known as Bayesian theory.
...
characteristics? These two questions can be slightly different answers, and
