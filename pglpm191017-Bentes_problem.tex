...
%% Last-Updated: 2020-01-18T23:33:58+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item the full histogram $\yH\defd(H_{0},H_{1}, H_{2},\dotsc)$ of the
  number of projections for that mouse: $H_{0}$ neurons (of the specific
  target class) receive no projection (from the specific input region);
  $H_{1}$ neurons receive only one projection; $H_{2}$ receive two
  projections; and so on. From such histogram we can calculate the mean and
  variance above; for example $\yNa = \frac{1}{J_{m}}\sum_{n}n\,H_{n}$.
\end{itemize}
