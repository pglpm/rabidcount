...
%% Last-Updated: 2020-01-21T00:12:29+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
$\yNm_{j}$ for each individual target neuron of each individual mouse; about
the statistics $\yFm$ for each individual mouse; and finally about the
super-statistics $\yS$ for all mice.


\subsubsection{One target neuron: exchangeability}
