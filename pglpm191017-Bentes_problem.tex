...
%% Last-Updated: 2020-01-20T23:27:17+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
%%\setlength{\intextsep}{0.5ex}% with wrapfigure
\begin{figure}[b!]%{r}{0.33\linewidth} % with wrapfigure
...
The expression of $\ka$ is simple: it corresponds to
\begin{equation}
  \label{eq:alpha_and}
  \ycm_{ij} =0 \quad\text{for }i=\yIhm+1,\dotsc,\yIm
  \quad\text{and }j=1,\dotsc,\yJhm.
\end{equation}
