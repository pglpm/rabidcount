...
%% Last-Updated: 2020-01-21T09:24:13+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
This distribution about the projections holds separately for each target
neuron $j$. But these distributions depend on knowledge of all the
...
Suppose that we know the statistics $\yF=(F_{0}, F_{1}, \dotsc, F_{I})$ of
such numbers for the full set of $J$ target neurons, as described in
\sect~\ref{sec:atomic_questions}. That is, $F_{0}$ is the proportion of all
target neurons receiving no projections from the input region, $F_{1}$ the
proportion receiving one projection, and so on.

Also in this case we make an assumption of symmetry: \emph{there isn't any
  reason for some target neuron $j'$ to have more or less projections than
  some other target neuron $j''$}. This is again an assumption of
exchangeability, and the discussion of its validity is analogous to that of
