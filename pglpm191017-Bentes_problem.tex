...
%% Last-Updated: 2020-01-20T13:41:37+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
Because of the way the virus infection works, our data tell us the following:
\begin{itemize}
\item We don't know anything about the projections of marked and unmarked
  ...
  region with the large yellow question mark in \fig~\ref{fig:datamouse}.
\item We know that the unmarked input neurons \emph{cannot} project to the
  ...
  and would be marked instead. Thus the lower-right, green part of the grid in
  \fig~\ref{fig:datamouse} has no black elements.
\item We know that each marked input neuron must project to \emph{at least
  ...
  and marked. This means that \emph{each row} in the upper-right, red part
  of the grid \emph{must have at least one black entry} -- but we don't
  know how many entries and where.
\end{itemize}
