...
%% Last-Updated: 2020-01-20T15:50:01+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
We want to express $\ka$ and $\kb$ in terms of the projection numbers
$\tu{N_{j}}$ and find the probability of obtaining the data we actually
observed:
\begin{equation}
  \label{eq:prob_infodata}
  \pf(\ka, \kb \| \yI) = \pf(\ka \| \kb, \yI) \times \pf(\kb \| \yI).
\end{equation}
