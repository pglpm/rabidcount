...
%% Last-Updated: 2020-01-16T13:49:22+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
mouse? Or are we asking about the average across all mice having some specific
characteristics? The difference is important for the application of the
probability-calculus, and the answers to these two questions can be
slightly different. We'll focus on these two kinds of questions:
