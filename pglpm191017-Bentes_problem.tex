...
%% Last-Updated: 2020-01-20T11:41:49+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
statements about the projection numbers $\yNm_{j}$. This will allow us to
use the probability~\eqref{eq:pre-data_final} in reverse: from the
$\yNm_{j}$ that make up the data we will make guesses about the
...
these answers are given by the statistics $\yFm$ and $\yS$, already expressed in
terms of the projection numbers $\yNm_{j}$ via
formulae~\eqref{eq:count_histogram} and \eqref{eq:count_superhistogram}.
These statistics already appear in the pre-data
probabilities~\eqref{eq:pre-data_final}. So 
